    ...
    public partial class Form : PortalModuleBase, IActionable
    {
        ...
        public string ControlPanelUrl
        {
            get
            {
                ...
                return ResolveUrl(string.Format("~/DesktopModules/BusinessEngine/Studio.aspx?s={0}&p={1}&a={2}&{3}={4}&m=create-form&return-url={5}", this.ScenarioName, this.PortalId, this.PortalAlias.PortalAliasID, moduleParam, moduleParamValue, "/Default.aspx?tabid=" + this.TabId));
            }
        }
